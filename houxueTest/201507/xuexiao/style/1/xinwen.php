...
//取得该学校的新闻
$sSql  = " select Id,Title,DTT,AreaId,CategoryId,Click from T_News";
$sSql .= " where T_News.LoginId='".$school["LoginId"]."'";
$sSql .= " order by T_News.Id desc limit 1000";
